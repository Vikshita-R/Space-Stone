...
def main():
    ...
    background_texture_id = load_texture("D:/Academic/code_project-main/code_project/background.jpg")
    texture_id = load_texture("D:/Academic/code_project-main/code_project/tesseract.png")
    ...
    while True:
        ...
        if break_cube and (current_time - break_time >= 8000):
            pygame.quit()
            quit()
